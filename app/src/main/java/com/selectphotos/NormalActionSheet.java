        ...
        if (mValues != null && mValues.size() > 0) {
            ...
            for (int i = 1; i <= size; i++) {
                ...
                if (i != size){
                    ...
                    view.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, (int) (0.5 * scale + 0.5F)));
                    view.setBackgroundColor(mContext.getResources().getColor(R.color.dialog_line));
